...
) ENGINE=InnoDB AUTO_INCREMENT=10500 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7238 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `idgen_seq_id_gen` (
  `id` int(11) NOT NULL,
  `next_sequence_value` bigint(20) DEFAULT NULL,
...
-- Dump completed on 2019-05-17  6:48:07
